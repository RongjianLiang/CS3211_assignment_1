...
tnoremap <C-W><Right> l
tnoremap <C-W><Up> k
tnoremap <C-W><Down> j
tnoremap <C-W><Left> h
abbr rea cs1010_read_array();2hi
abbr forl for (int i = 0; i < ; i++) {7hi
abbr sop System.out.print("");2hi
abbr sout System.out.println("");2hi
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 32 + 98) / 196)
exe 'vert 2resize ' . ((&columns * 32 + 98) / 196)
exe 'vert 3resize ' . ((&columns * 32 + 98) / 196)
exe 'vert 4resize ' . ((&columns * 32 + 98) / 196)
exe 'vert 5resize ' . ((&columns * 32 + 98) / 196)
exe 'vert 6resize ' . ((&columns * 31 + 98) / 196)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists("OrderBook.cpp") | buffer OrderBook.cpp | else | edit OrderBook.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <silent> <S-F9> :call C_Arguments()
imap <buffer> <silent> <C-F9> :call C_Run()
...
wincmd w
argglobal
if bufexists("engine.hpp") | buffer engine.hpp | else | edit engine.hpp | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <silent> <S-F9> :call C_Arguments()
imap <buffer> <silent> <C-F9> :call C_Run()
...
wincmd w
argglobal
if bufexists("BookShelf.cpp") | buffer BookShelf.cpp | else | edit BookShelf.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <silent> <S-F9> :call C_Arguments()
imap <buffer> <silent> <C-F9> :call C_Run()
...
wincmd w
argglobal
if bufexists("BookShelf.hpp") | buffer BookShelf.hpp | else | edit BookShelf.hpp | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <silent> <S-F9> :call C_Arguments()
imap <buffer> <silent> <C-F9> :call C_Run()
...
wincmd w
argglobal
if bufexists("RestOrder.cpp") | buffer RestOrder.cpp | else | edit RestOrder.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <silent> <S-F9> :call C_Arguments()
imap <buffer> <silent> <C-F9> :call C_Run()
...
exe 'vert 6resize ' . ((&columns * 31 + 98) / 196)
tabnext 1
badd +0 RestOrder.cpp
badd +0 BookShelf.hpp
badd +0 BookShelf.cpp
badd +0 OrderBook.cpp
badd +0 engine.cpp
badd +0 engine.hpp
