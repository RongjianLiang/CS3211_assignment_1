...
exe 'vert 2resize ' . ((&columns * 29 + 60) / 120)
exe 'vert 3resize ' . ((&columns * 29 + 60) / 120)
exe 'vert 4resize ' . ((&columns * 29 + 60) / 120)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 153 - ((9 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
153
...
wincmd w
argglobal
if bufexists("engine.cpp") | buffer engine.cpp | else | edit engine.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <silent> <S-F9> :call C_Arguments()
imap <buffer> <silent> <C-F9> :call C_Run()
